      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          ...
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1051'">
            <xsl:text>DSTU GOST – Číselný odkaz</xsl:text>
          </xsl:when>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1060'">
            <xsl:text>DSTU GOST – številčni sklic</xsl:text>
          </xsl:when>
        </xsl:choose>
      </xsl:when>
